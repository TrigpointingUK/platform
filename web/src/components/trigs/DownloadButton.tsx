...
interface DownloadButtonProps {
  ...
  logUserName?: string;
  /** "subtle" for a quiet icon-only button beside more important controls */
  ...
  return (
    <div className={className}>
      <button
        ...
        disabled={isLoading}
        aria-label={iconOnly ? (isLoading ? "Downloading" : "Download") : undefined}
