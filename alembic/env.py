...
# Import FastAPI settings and database models
from api.core.config import settings
from api.db.database import Base

# Import all models so Alembic can detect them for autogenerate
from api.models.user import User, TLog, TPhotoVote, TQuery, TQuizScores
...
# Override the sqlalchemy.url from alembic.ini with FastAPI settings
