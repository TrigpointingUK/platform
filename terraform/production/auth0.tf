...
moved {
  from = cloudflare_record.ses_mail_from_mx
  to   = cloudflare_dns_record.ses_mail_from_mx
}

moved {
  from = cloudflare_record.ses_mail_from_spf
  to   = cloudflare_dns_record.ses_mail_from_spf
}
