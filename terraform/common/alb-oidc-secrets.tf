...
resource "aws_secretsmanager_secret" "alb_oidc" {
  ...
  description = "Auth0 OIDC configuration for ALB authentication (cache.trigpointing.uk, phpmyadmin.trigpointing.uk, preview.trigpointing.uk, trigpointing.me staging)"
