...
# cloudflare_record was renamed to cloudflare_dns_record
moved {
  from = cloudflare_record.api_staging
  to   = cloudflare_dns_record.api_staging
}

moved {
  from = cloudflare_record.api_production
  to   = cloudflare_dns_record.api_production
}
...
moved {
  from = cloudflare_record.preview
  to   = cloudflare_dns_record.preview
}
...
moved {
  from = cloudflare_record.test1
  to   = cloudflare_dns_record.test1
}

moved {
  from = cloudflare_record.test2
  to   = cloudflare_dns_record.test2
}

moved {
  from = cloudflare_record.forum
  to   = cloudflare_dns_record.forum
}

moved {
  from = cloudflare_record.phpmyadmin
  to   = cloudflare_dns_record.phpmyadmin
}

moved {
  from = cloudflare_record.static
  to   = cloudflare_dns_record.static
}

moved {
  from = cloudflare_record.wiki
  to   = cloudflare_dns_record.wiki
}

moved {
  from = cloudflare_record.root_domain_staging
  to   = cloudflare_dns_record.root_domain_staging
}

moved {
  from = cloudflare_record.root_domain_production
  to   = cloudflare_dns_record.root_domain_production
}

moved {
  from = cloudflare_record.www_staging
  to   = cloudflare_dns_record.www_staging
}

moved {
  from = cloudflare_record.www_production
  to   = cloudflare_dns_record.www_production
}

# Handle resource renames to add environment suffixes (old migration)
moved {
  from = cloudflare_dns_record.root_domain
  to   = cloudflare_dns_record.root_domain_production
}
