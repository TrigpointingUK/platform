...
print_warning "⚠️  STAGING DATABASE ONLY ⚠️"
print_status "Alembic Migrations - Bastion Execution (Staging)"
echo "============================================================"
...
echo ""
echo "🔐 Loading STAGING PostgreSQL credentials from AWS Secrets Manager..."
...
echo "✅ Connected to STAGING database: ${PG_HOST}/${PG_DATABASE}"
echo ""
...
print_success "Alembic migrations completed on STAGING!"
echo ""
print_status "Next steps:"
echo "  1. Test the /users/browse endpoint on staging"
